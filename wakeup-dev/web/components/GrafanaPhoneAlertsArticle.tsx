...
import type { GrafanaPhoneAlertsContent } from "@/lib/marketing/grafana-phone-alerts-content";

export function GrafanaPhoneAlertsArticle({
  content: c,
}: {
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
      ...
      <section className="mt-12">
        ...
        <p className="mt-3 text-zinc-400 leading-relaxed">{c.exampleIntro}</p>
        <h3 className="mt-6 text-lg font-medium text-zinc-200">
          {c.exampleCurlLabel}
        </h3>
