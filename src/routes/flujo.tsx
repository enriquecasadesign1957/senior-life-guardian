...
export const Route = createFileRoute("/flujo")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Mira cómo Senior Safe activa tu protección automáticamente: pago, cuenta, prueba de 7 días, bienvenida y onboarding." },
    ],
  }),
  component: FlujoPage,
});
...
const STEPS = [
  { icon: CreditCard, color: DEEP,    title: "Contratas tu plan",            desc: "Eliges Básico o Premium en el sitio." },
  ...
  { icon: Clock,      color: AMBER,   title: "Prueba de 7 días activada",    desc: "Sin cobros durante el período de prueba." },
          ...
          {done && (
            <div className="mt-10 rounded-3xl p-8 md:p-10 text-white text-center shadow-2xl animate-fade-in" style={{ background: `linear-gradient(135deg, ${GREEN}, #15803d)` }}>
              ...
              <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
                <Link to="/checkout" className="inline-flex items-center justify-center gap-2 px-7 py-4 rounded-full bg-white font-bold shadow-lg hover:scale-[1.02] transition" style={{ color: DEEP }}>
