/**
 * Aplica migración pin_reset_codes en Supabase producción.
...
const sqlPath = path.resolve(
  process.cwd(),
  "supabase/migrations/20260623120000_pin_reset_codes.sql",
);
...
try {
  ...
  await client.end();
  console.log("Migración pin_reset_codes aplicada correctamente.");
  process.exit(0);
} catch (e) {
  console.error("No se pudo aplicar la migración:", e?.message ?? e);
  try {
    await client.end();
  } catch {
    /* ignore */
