/**
 * Aplica migración pending_first_guardian en Supabase producción.
 * Uso: node scripts/apply-pending-guardian-migration.mjs
 */
...
const sqlPath = path.resolve(
  process.cwd(),
  "supabase/migrations/20260608120000_pending_first_guardian.sql",
);
...
try {
  ...
  await client.end();
  console.log("Migración pending_first_guardian aplicada correctamente.");
} catch (e) {
